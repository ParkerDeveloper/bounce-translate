...
public:
	...
	HRESULT		Print(QString text, SRColor color, float x, float y, bool skipColorTags = false, bool noColorFormat = false );
...
public:
	...
	bool	DrawLine ( const D3DXVECTOR3 &a, const D3DXVECTOR3 &b, SRColor color );
protected:
	HRESULT Initialize ( IDirect3DDevice9 *pD3Ddev );
	HRESULT Invalidate ();
private:

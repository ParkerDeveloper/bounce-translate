#ifndef PROXYDIRECTX_H
#define PROXYDIRECTX_H
...
public:
	...
	HRESULT __stdcall   GenerateShader ( IDirect3DPixelShader9 **pShader, float alpha, float red, float green,
										 float blue );
	IDirect3DDevice9*   getOriginalDevice();

	void    __stdcall   RegisterFont( CD3DFont *pFont );
	void    __stdcall   ReleaseFont( CD3DFont *pFont, bool autoDelete = true );
	void    __stdcall   RegisterRender( CD3DRender *pRender );
	void    __stdcall   ReleaseRender( CD3DRender *pRender, bool autoDelete = true );
	void    __stdcall   RegisterTexture( SRTexture *pTexture );
	void    __stdcall   ReleaseTexture( SRTexture *pTexture, bool autoDelete = true );
};

#endif // PROXYDIRECTX_H
